                ...
                <Grid container alignItems="center" spacing={{ xs: 2, md: 10 }}>
                    <Grid item xs={12} md={6}>
                        ...
                        <Typography color="#77829D" lineHeight={1.8}>
                            ...
                            plans, including management of chronic diseases. If
                            we cannot assist, we can provide referrals or advice
                            about the type of practitioner you require. We treat
                            all enquiries sensitively and in the strictest
                            confidence.
                        </Typography>
                    </Grid>
